...
0	CLS
	...
	P6!=&HD3A9
	P7!=&HD3F1
	DIM C(23),D(23),M$(117),V$(17),N$(27)	REM C=ObjetsDétenus D=EtapesFranchies M=Messages V=Verbes N=Complements
	RESTORE 236
	SCREEN7,0,0
	GOSUB234
	GOTO18
...
REM *** Ajout d'un séparateur entre verbe et complément ***
2 R$=INPUT$(1)
...
46 LOCATE0,0,0
	CLS
	PRINT"Vous devez remettre les lettres à leur"
	PRINT"place en permutant deux lettres à cha-"
	PRINT"-que fois"
	F=LEN(M2$)
	PRINT
	PRINTM$(58);
...
62 COLOR7
	PRINT
	PRINT
	PRINT"La combinaison a";F;"chiffres de 0 à";Q-1
	CONSOLE0,24
	COLOR0,2
	LOCATE29,0,0
	PRINT"Combinaison"
...
72 COLOR1
	...
	PRINT"chiffres de la différence entre le "
...
96 COLOR3
	...
	IFE$=C1$THENPLAYM4$
	CLS
	GOSUB190	REM *** Animation : Fait apparaitre une porte secrète ***
	D(20)=1
	RETURN
...
107 IFC(2)=1THENA0=A0+1						REM *** 
	ELSEIF(P=46ANDN=4)OR(P=0ANDN=12)THENM=4	REM *** Il est fixé au sol (Pièce 46 Prendre Livre), (Pièce 0 Prendre Vase) ***
	GOSUB7
	RETURN
...
REM *** ***
140 IFN=9ANDP=36THENIFD(1)=1THENM=83	REM *** Pièce 36 PRO FOR Prononcer formule ***
	GOSUB7
	RETURN
	ELSEGOSUB190	REM *** Pièce 36 Animation : Fait apparaitre une porte secrète ***
	D(1)=1
	M=20
	GOSUB7
	RETURN
...
143 IFN=22THENIFP=60THENIFD(19)=1THENM=48
	...
	GOSUB7
	RETURN
	ELSEIFN=22THENIFP=36THENM=98	REM *** Pièce 36 LIR MES Lire Message ***
	GOSUB7
	RETURN
	ELSEM=91
	GOSUB7
...
164 IFN=11ANDP=18THENIFC(4)=0THENM=13	REM *** P=18 Pièce numero 18 *** Avec Quoi ? C(4)=0 pas de Mastic *** 
	GOSUB7
	RETURN
	ELSEM=81	REM *** L'eau s'arrête de monter ***
	D(3)=1		REM *** D(3)=1 ***
	GOSUB7
	RETURN
...
REM *** Animation : Fait apparaitre une porte secrète ***
190 PLAYM6$
	COLOR0
	RESTORE191
...
196 COLOR1,0
	...
	PRINT"FELICITATIONS!"
	COLOR6
	PRINT"Votre mission est réussie.Grâce à vous"
...
235 CONSOLE0,18
	...
	PRINT"Agent WO5."
	LOCATE1,3
	PRINT"Vous êtes chargé par le CSSE.STOP.de"
	PRINT
	PRINT"neutraliser la machine infernale.STOP."
	LOCATE2,7
	PRINT"que le Professeur Antirot.STOP.exclu"
	LOCATE1,9
	PRINT"de la communauté des savants sains"
	LOCATE3,11
	PRINT"d'esprit.STOP.a mise au point pour"
	LOCATE0,13
	PRINT"empêcher la Terre de tourner.STOP."
	LOCATE2,15
	PRINT"Dépêchez-vous!et...Bonne chance.STOP."
...
REM *** ***
237 M$(100)="Vous découvrez un petit carnet"
	M$(101)="Il y a pas mal de poussiere"
	M$(102)="C'est un tapis très persan"
	M$(103)="Ne frottez pas trop fort!"
	M$(104)="Regardez bien!"
	M$(105)="Toutes les pages sont blanches"
	M$(106)="Vous lisez VITE"
	M$(107)="Le citron se révèle sympa..."
	M$(108)="Que voulez-vous lire?"
	M$(109)="Votre mission s'arrête ici!..."
	M$(110)="Voulez-vous repartir?(O/N)!"
	M$(111)="Sur la plaque:	Ici repose WO4..."
	M$(112)="Sur la plaque:	Votre place est réservée"
	M$(113)="Verbe inexistant"
	M$(114)="Complément inexistant"
	M$(115)="La nitro ouvre une brèche"
	M$(116)="Vous pouvez prendre la bourse!.."
	M$(117)="Ne touchez à rien!!"
	M$(1)="Je ne comprends pas"
	M$(2)="Exprimez-vous plus clairement!"
	M$(3)="Pardon?"
	M$(4)="Il est fixé au sol"
	M$(5)="Les pages sont collées"
	M$(6)="D'accord"
	M$(7)="Comme vous voulez"
	M$(8)="Voila qui est fait"
	M$(9)="Et maintenant?"
	M$(10)="Elle est ouverte"
	M$(11)="Il n'y a rien à prendre ici!"
	M$(12)="Vous voulez rire!"
	M$(13)="Avec quoi?"
	M$(14)="Gloub;gloub;gloub..."
	M$(15)="Tiens!Où êtes-vous passé?"
	M$(16)="L'étiquette est effacée.On ne voit que:	....o..y....n."
	M$(17)="Bien joué!"
	M$(18)="Impossible!"
	M$(19)="Je ne vois vraiment rien!"
	M$(20)="Tiens!Un passage secret"
	M$(21)="Vous chopez une bonne grippe!"
	M$(22)="Il est déja ouvert"
	M$(23)="Il n'y a rien de spécial"
	M$(24)="On dirait du champagne"
	M$(25)="La fiole est vide"
	M$(26)="Quel cercueil?"
	M$(27)="Le révolver n'est pas chargé"
	M$(28)="Attention aux ricochets!"
	M$(29)="C'est trop tard!Tout va sauter!!"
	M$(30)="Ce sont des cartouches"
	M$(31)="C'est du mastic étanche"
	M$(32)="Amusez-vous bien!"
	M$(33)="La porte est verrouillée"
	M$(34)="Un puissant séchoir se met en marche"
	M$(35)="Le gardien vous a vu le premier,hélas!"
	M$(36)="Vous avez éliminé le gardien"
	M$(37)="Comment avancer?"
	M$(38)="Il y a un souterrain tout noir"
	M$(39)="C'est trop tard!..."
	M$(40)="Et comment?"
	M$(41)="La serrure est blindée"
	M$(42)="Du bruit à coté"
	M$(43)="Bienvenu!Je vous ai gardé une place..."
	M$(44)="La porte est bloquée"
	M$(45)="Une cellule photo-électrique actionne un laser mortel"
	M$(46)="Vous continuez sans l'objet"
	M$(47)="C'était de l'acide fluorhydrique!"
	M$(48)="C'est déja fait"
	M$(49)="Un serpent à lunettes ne vous rate pas"
	M$(50)="2546 volts vous foudroient"
	M$(51)="Vous ne l'avez pas"
	M$(52)="Vous allez vous cogner!"
	M$(53)="La porte est encore fermée"
	M$(54)="La serrure a sauté"
	M$(55)="Voici le coffre!!!"
	M$(56)="Tiens!Une clé"
	M$(57)="Prendre quoi?"
	M$(58)="Appuyer une touche"
	M$(59)="C'est un vase d'époque Ming"
	M$(60)="Bizarre,vraiment bizarre"
	M$(61)="Il faut d'abord trouver son nom"
	M$(62)="Quelle clé?"
	M$(63)="Le coffre est fermé"
	M$(64)="Vous l'avez bien méritée!"
	M$(65)="Vous croyez aux sermons,vous?"
	M$(66)="Attention!il est chargé"
	M$(67)="La bouteille d'acide fluorhydrique s'est ouverte et vous étouffez"
	M$(68)="Vous l'avez déja!"
	M$(69)="C'est une Bible reliée"
	M$(70)="Vous êtes bien méfiant tout à coup!"
	M$(71)="C'est une flûte indienne"
	M$(72)="Quel coffre?"
	M$(73)="C'est un vrai coffre-fort"
	M$(74)="Vous dites n'importe quoi!"
	M$(75)="Vous êtes terrassé par les vapeurs d'acide fluorhydrique"
	M$(76)="Quelle porte?"
	M$(77)="Avez vous le mot de passe?"
	M$(78)="La serrure est codée"
	M$(79)="Que voulez-vous boire?"
	M$(80)="Là,vous détonnez!"
	M$(81)="L'eau s'arrête de monter"
	M$(82)="Vous vous suicidez déja?"
	M$(83)="Pour quoi faire?"
	M$(84)="Vraiment,vous croyez?"
	M$(85)="Vous ne l'avez plus"
	M$(86)="Quel vase?"
	M$(87)="Sacré fouilleur va!"
	M$(88)="Oö çà?"
	M$(89)="Vous transformer en souris?!"
	M$(90)="Voici la clé du codage"
	M$(91)="Quel message?"
	M$(92)="Voici une indication"
	M$(93)="Le gardien ne vous voit pas"
	M$(94)="La machine infernale se met en marche.."
	M$(95)="C'est une clé de coffre-fort"
	M$(96)="Que voulez-vous examiner?"
	M$(97)="Vous vous prenez pour Fantomas?!"
	M$(98)="Heureux qui comme ALI BABA..."
	M$(99)="Vous découvrez une petite boite"
	FORI=0TO31
	READA,B
	...
	NEXTI
	FORI=1TO27
	READN$(I)	REM *** Chargement des Compléments dans N$ ***
	NEXTI
	...
	K$=CHR$(127)									REM *** Graphisme : Carré plein ***
	M1$(0)=GR$(11)+" "								REM *** Graphisme : flêche vers haut gauche ***
	M1$(1)=" "+GR$(10)								REM *** Graphisme : flêche vers haut droite ***
	...
	DEFGR$(44)=192,240,252,255,255,255,255,255		REM *** Graphisme : pente montée ? ***
	...
	T0$=GR$(44)+GR$(45)								REM *** Graphisme : pente montée ? ***
	...
	COLOR1,0
	LOCATE3,22
	PRINT"Avez-vous sauvegardé la situation"
	LOCATE12,23
	PRINT"précédente?(O/N)"
	R$=INPUT$(1)
	IFR$="N"THEN239
